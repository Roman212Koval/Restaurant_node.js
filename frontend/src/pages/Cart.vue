<template>
    <div class="shopping-cart-section">
        ...
        <div class="heading">
            <span>Кошик</span>
            <h3>Смачна їжа, швидка доставка 😉</h3>
        </div>
            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="in-cart col-md-9">
                        <div class="box">
                            <div class="box-title item-total row">
                                <h3>
                                    <p style="font-size: 15px;">{{ filterFoods.length.toString() }}
                                        <span v-if="filterFoods.length == 1">позиція</span>
                                        <span v-if="filterFoods.length == 0">позицій</span>
                                        <span v-else>позиції</span>
                                    </p>в кошику
                                </h3>
                            </div>
                            ...
                            <div v-if="!filterFoods.length">
                                <div class="box-content row no-food">
                                    <div class="content">
                                        <h2 style="color: #057835fa;">У вашому кошику немає товарів, додайте в нього щось. 🙈</h2>
                                    </div>
                                    <div class="image">
                                    ...
                                    <div class="box-content row">
                                        ...
                                        <div class="desc col-sm-4">
                                            ...
                                            <button class="btn remove-btn" @click="removeBtn(index)"><i
                                                    class="fa fa-trash"></i>Видалити</button>
                                        </div>
                                        ...
                                        <div class="item-qty col-sm-2 d-inline">
                                            <label for="iQuantity"
                                                style="font-size: 12px; padding-right: 2px;">Оцінка:</label>
                        ...
                        <div class="box-content row">
                            <router-link to="/menu" class="btn shop-btn"><i class="fa fa-arrow-left"></i>Продовжити 
                                покупки</router-link>
                            <button class="btn check-out-btn" style="margin-left: 10px;"
                                :disabled="filterFoods.length ? false : true" @click="checkOutBtn()"><i
                                    class="fa fa fa-shopping-cart"></i>Оформити замовлення</button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +38 097 123 123</h3>
                                <span class="small">
                                    Зв'яжіться з нами за потреби. Ми доступні цілодобово.
                                </span>
                            </div>
                        </div>
                    </div>
