<template>
    <div class="thank-container">
        ...
        <div class="thank-letter">
            <p v-none>Спасибі, що Ви з нами!</p>
            <p v-none>
                Ми щойно підтвердили отримання вашого замовлення і сподіваємося, 
                що ви насолодитесь ним. Кожен елемент виготовлений нашою командою 
                вручну з увагою до деталей, щоб завжди забезпечувати вам найкращі враження.
            </p>
            <router-link class="btn" to="/menu">Продовжити покупки</router-link>
        </div>
    </div>
</template>
