<template>
        ...
        <div class="quick-view-inner" v-for="f in selectedFood" :key="f">
            ...
            <div class="product-detail d-flex">
                ...
                <div class="content">
                    ...
                    <button class="btn" @click="addToCart">В кошик</button>
                </div>
            </div>
        </div>
    </div>
    <div v-else class="quick-view">
        <div class="quick-view-inner">
            <h2 class="d-flex justify-content-between">Увійдіть, щоб скористатися цим
                <slot></slot>
            </h2>
            <div class="link-to-login" style="text-align: center; margin-top: 120px;">
                <router-link class="btn" to="/login" style="padding: 28px; font-size: 24px">Увійти зараз
                </router-link>
            </div>
        </div>
    </div>
    ...
    methods: {
        ...
        async addToCart() {
            ...
            if (existItem.data.length == 1) {
                ...
                this.$refs.alert.showAlert('success', 'Чудово!', 'Успішно додано в кошик!')
