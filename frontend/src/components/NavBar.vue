<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/logo.png" alt="" />Млин
        </router-link>

        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/">Головна</router-link>
            <router-link @click="scrollToTop()" to="/about">Про нас</router-link>
            <router-link @click="scrollToTop()" to="/promotions">Акції</router-link>
            <router-link @click="scrollToTop()" to="/menu">Меню</router-link>
            <router-link @click="scrollToTop()" to="/table">Бронювання</router-link>
        </nav>
        ...
        <div class="icons">
            ...
            <div v-if="!user" class="fas fa-user account" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/login">Увійти</router-link>
                    </li>
                    <li>
                        <router-link @click="scrollToTop()" to="/register">Реєстрація</router-link>
                    </li>
                </ul>
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/myorder">Замовлення</router-link>
                    </li>
                    <li>
                        <router-link @click="handleLogout" to="/">Вийти</router-link>
                    </li>
                </ul>
            </div>
