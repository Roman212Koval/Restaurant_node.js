<template>
    <div class="order-details">
        <div class="order-details-inner">
            <h2 class="d-flex justify-content-between">Відомості про замовлення
                <slot></slot>
            </h2>
            ...
            <div class="price">
                <p>Знижка: {{ billMatch.bill_discount }} ₴</p>
                <p>Доставка: {{ billMatch.bill_delivery }} ₴</p>
                <p>Загалом: {{ billMatch.bill_total }} ₴</p>
            </div>
        </div>
    </div>
</template>
